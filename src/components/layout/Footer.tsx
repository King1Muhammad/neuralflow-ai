        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          <div className="lg:col-span-2">
            ...
            <p className="max-w-md text-foreground/60 mt-4">
              Empowering humans and businesses to thrive in the AI era through intelligent automation solutions.
            </p>
          ...
          <div className="mt-8 md:mt-0">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/privacy-policy" className="text-foreground/60 hover:text-white transition-colors">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms-of-service" className="text-foreground/60 hover:text-white transition-colors">
                  Terms of Service
                </Link>
              </li>
            </ul>
