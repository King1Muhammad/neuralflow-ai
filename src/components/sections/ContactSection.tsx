...
const ContactSection = () => {
  ...
  const onSubmit = async (data: FormData) => {
    try {
      // Create email body
      const emailBody = `
New contact form submission from Neural Flow website:
...
---
Sent from Neural Flow Contact Form
      `.trim();

      // Create mailto link
      const subject = encodeURIComponent(`New Contact Form Submission - ${data.company}`);
      const body = encodeURIComponent(emailBody);
      const mailtoLink = `mailto:neuralflow.cloud@gmail.com?subject=${subject}&body=${body}`;
      ...
      toast({
        ...
        description: 'A new email will be created with your form details. Please send it to complete your submission.',
      });
      ...
      toast({
        ...
        description: 'Please try again or contact us directly at neuralflow.cloud@gmail.com',
        variant: 'destructive',
      });
    }
  }
  ...
  const openEmail = () => {
    window.location.href = 'mailto:neuralflow.cloud@gmail.com?subject=Business Inquiry&body=Hello Neural Flow team, I would like to discuss...';
  };

  return (
    <section ref={sectionRef} id="contact-section" className="py-12 sm:py-16 lg:py-20 relative overflow-hidden section-transition">
      <WaveBackground color="#00c2ff" speed={0.5} />
      <div className="absolute inset-0 bg-gradient-to-t from-dark-purple via-transparent to-dark-purple/50"></div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center mb-12 lg:mb-16 scroll-reveal">
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground/80 leading-relaxed animate-slide-in-up" style={{ animationDelay: '0.3s' }}>
            Let's discuss how Neural Flow can revolutionize your operations with cutting-edge AI automation. 
