...
const IndustriesSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 relative overflow-hidden section-transition">
      <NetworkBackground nodeCount={60} color="#00c2ff" />
      <div className="absolute inset-0 bg-gradient-radial from-transparent via-dark-purple/10 to-dark-purple/30"></div>
