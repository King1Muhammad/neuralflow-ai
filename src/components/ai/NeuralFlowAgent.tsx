...
const NeuralFlowAgent = ({ isOpen, onClose }: NeuralFlowAgentProps) => {
  ...
  const getGeminiResponse = async (userMessage: string): Promise<string> => {
    try {
      ...
      return 'I apologize, but I\'m having trouble connecting right now. Please contact us directly at neuralflow.cloud@gmail.com or WhatsApp +92 310 5163094 for immediate assistance.';
    }
  };
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const errorResponse: Message = {
        id: (Date.now() + 1).toString(),
        text: 'I encountered an error. Please contact our support team directly at neuralflow.cloud@gmail.com or WhatsApp +92 310 5163094.',
        isUser: false,
        timestamp: new Date(),
      };
